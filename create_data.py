...
for dataset in datasets:
    ...
    for t in proteins.keys():
        prots.append(t) #chuyển thành key để lấy 3d
    if dataset == 'davis':
...
for dataset in datasets:
    print(dataset)  
    processed_data_file_train = 'data/processed/' + dataset + '_train_drug.pt'
    processed_data_file_test = 'data/processed/' + dataset + '_test_drug.pt'
